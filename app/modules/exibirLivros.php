            ...
            if ($result->num_rows > 0) {
               ...
               <div class="card-body-exibir p-3 border border-white  m-3">
                    ...
                    <ul class="card_body_ul d-flex gap-4 align-items-center p-0 m-0">
                        ...
                        <li> <a href="src/delete.php?tipo=livro&id=' . $row['id_livro'] . '" class="card-link-del" onclick="return confirmDelete();"><img src="../assets/delete.svg" alt="Deletar" class="px-1"></a></li>
                    </ul>
                </div> 
            ';
                }
