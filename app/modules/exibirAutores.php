        ...
        <nav class="navbar navbar-expand-lg  header_container">
            <div class="container-fluid">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#git" aria-controls="navbarSupportedContent"
    ...
    <main class="container_main">
        ...
        from autor";
            ...
            if ($result->num_rows > 0) {
               ...
               <div class="card-body-exibir p-3 border border-white  m-3">
                    ...
                    <ul class="card_body_ul d-flex gap-4 align-items-center p-0 m-0">
                        ...
                        <li> <a href="src/delete.php?tipo=autor&id=' . $row['id_autor'] . '" class="card-link-del" onclick="return confirmDelete();"><img src="../assets/delete.svg" alt="Deletar" class="px-1"></a></li>
          ...
          <div class="container_main_vazio d-flex flex-column align-items-center pt-5">
            <img class="w-25" src="../assets/livro-removebg-preview.png" alt="Nenhum autor cadastrado...">
            <a class="text-center" href="formAutor.php">
                <p class="container_main_vazio_paragrafo">Nenhum autor cadastrado...</p>
            </a>
          </div>';
            }
